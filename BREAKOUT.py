...
class App:
    ...
    def vunnet(self):
        ...
        text = font.render("Gratulerer! Spillet er vunnet!", True, (0, 0, 0))
    ...
    def render(self, vindu):
        ...
        if not self._trykket:
            ...
            text = font.render("Trykk på piltast til høyre/venstre", True, (0, 0, 0))
...
class Ball:
    ...
    def _begynn_bevegelse(self):
        ...
        self.dx = 4 * (-1) ** r(
            1, 2
        )  # randint, slik at det er tilfeldig hvilken retning ballen begynner
